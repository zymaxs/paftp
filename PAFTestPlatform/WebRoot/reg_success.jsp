...
<div class="container-fluid"> 
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="row-fluid">
          ...
          <div class="span2 whitelink"><a href="register.html">注册</a> | 登录</div>
        </div>
        <div class="row-fluid">
  ...
  <script type="text/javascript">countDown(5,'http://localhost:8080/PAFTestPlatform/index_1.jsp');</script> 
  </div>
  </div>
  <!--网页底部-->
