			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="row-fluid">
						...
						<div class="span3 whitelink"
							style="text-align:center;font-size:15px; font-family:Microsoft YaHei;">
							<a href="updateuserinfo.jsp"><%=name%> </a>| <a
								href="logout.jsp">登出</a>
						</div>
						<%
							}
						%>
		...
		<div id="loginmodal" style="display:none;">
			...
			<form id="loginform" name="loginform" method="post" action="">
				...
				<input type="text" name="alias" id="alias" class="txtfield"
					tabindex="1"> <label for="password"
					style="Microsoft YaHei; font-size:12px;">Password:</label> <input
				...
				<div class="center">
					<input type="button" name="loginbtn" id="loginbtn"
						...
						onClick="loginac()"> <input type="button"
