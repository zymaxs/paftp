    ...
    <table border="1" width="100%">
      <tr>
        <td width="25%"><div style="height:450px;overflow:scroll;overflow-x:hidden;">
          ...
          <td width="75" id="iniTd" style="display:block; text-align:center" >
          HelloWorld!
          </td>
          <td width="75%" style="display:none" id="newTestSuiteTd"><form>
            ...
            <tr>
              ...
              <tr>
              	<td colspan="2">
                	<button type="button" class="btn btn-default" onClick="newTestSuiteac()" id="newTestSuite" name="newTestSuite">确认</button>
              	</td>
              </tr>
          </table>
          </form></td>
          ...
          <td width="75%" style="display:none" id="newTestCaseTd"><form>
            ...
            <tr>
              ...
              <tr>
              	<td colspan="2">
                	<button type="button" class="btn btn-default" onClick="newTestCaseac()" id="newTestCase" name="newTestCase">确认</button>
              	</td>
              </tr>
          </table>
          </form></td>
          <td width="75%" style="display:none" id="showTestCaseTd">
          <form>
          <table width="100%">
          <tr>
